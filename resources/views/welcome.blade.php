<x-site-layout title="Proctique">
    ...
    @if (filled($trendingProjects) && $trendingProjects->count())
    ...
    <section id="recent-projects">
        ...
        @else
            <div class="rounded-3xl bg-blue-50 border border-blue-100 p-8 sm:p-12 text-center">
                <h3 class="text-2xl sm:text-3xl font-semibold">No projects yet</h3>
                <p class="mt-3 text-gray-700">Be the first to share your work with the community.</p>
